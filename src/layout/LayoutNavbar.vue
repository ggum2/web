      ...
      <b-navbar-nav class="align-items-lg-center">
        ...
        <label class="nav-item navbar-text navbar-search-box p-0 active">
          ...
          <span class="navbar-search-input pl-2">
            <input type="text" class="form-control navbar-text mx-2 text-lightest" placeholder="Search..." style="width:200px">
          </span>
        </label>
      </b-navbar-nav>
        ...
        <b-nav-item-dropdown :right="!isRTL" class="demo-navbar-user">
          <template slot="button-content">
            <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
              <img src="https://avatars3.githubusercontent.com/u/12694841?s=460&v=4" alt class="d-block ui-w-30 rounded-circle">
              <span class="px-1 mr-lg-2 ml-2 ml-lg-0">jhyunto</span>
            </span>
          </template>
